...
### 3. Use and Optimize PID Parameters
...
This project is based on NADE (Naturalistic and Adversarial Driving Environment) from Michigan Traffic Lab. This research investigates the role of co-training techniques to improve robustness and safety under adversarial agents :
